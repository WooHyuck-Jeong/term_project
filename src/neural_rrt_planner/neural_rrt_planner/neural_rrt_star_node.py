#!/usr/bin/env python3
"""
ROS2 Node for Neural-Guided RRT* path planning.

informed_rrt_star_node.py 구조를 그대로 따르되
아래 두 가지만 변경한다:
    1. NeuralRRTStar 플래너 사용
    2. 트리 색상: 보라색 (Neural 단계 구분)
...
class NeuralRRTStarNode(Node):

    def __init__(self):
        super().__init__("neural_rrt_star_node")

        self.marker_pub = self.create_publisher(
            MarkerArray,
            "/neural_rrt_star/markers",
            10,
        )
